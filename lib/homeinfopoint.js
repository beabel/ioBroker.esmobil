 ...
 *
 * @param loginUrl URL of the login form (login.php)
 * @param dataUrl URL of the data page to fetch after login
 * @param username Home.InfoPoint username
 * @param password Home.InfoPoint password
 */
 ...
 *
 * @param html raw Home.InfoPoint data page HTML
 */
